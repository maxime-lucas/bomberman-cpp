...
{
    SDL_Surface *fond ,*logo ,*startButtonN ,*startButtonH ,*quitButtonN ,*quitButtonH; /*sprites ecran accueil*/
    ...
    startButtonN = IMG_Load("img/start-screen/Start-normal.png"); /*chargement des boutons*/
    startButtonH = IMG_Load("img/start-screen/Start-hovered.png");
    quitButtonN = IMG_Load("img/start-screen/Quit-normal.png");
    quitButtonH = IMG_Load("img/start-screen/Quit-hovered.png");
