...
{
	SDLKey tabkey[NB_PLAYERS][4] = { {SDLK_UP,SDLK_DOWN,SDLK_LEFT,SDLK_RIGHT} , {SDLK_t,SDLK_g,SDLK_f,SDLK_h} };
...
{ 
	...
	{  
		...
		if( ( t->getType() >= TILE_WALL ) && (  t->getType() <= TILE_WALL ) ) 
		{ 
